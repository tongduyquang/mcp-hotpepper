 ...
 * - 3. Recommendation (e.g., There are available options for me to choose from)
 * ### Type 1:
 ...
 * ### Type 3:
 * 3.1 Search by special options
 * 3.2 Search by special_category options
 * 3.3 Search by budget options
 * 3.4 Search by genre options
 */
...
export const SEARCH_GOURMETS_BY_OPTIONS: Tool = {
  name: 'search_gourmet_by_options',
  description: '',
  inputSchema: {
    type: 'object',
    properties: {
